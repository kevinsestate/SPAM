...
\begin{itemize}
    \item \texttt{docs/benchmarks/artifacts/environment.txt}
    \item \texttt{docs/benchmarks/artifacts/test\_spam\_calc\_output.txt}
    \item \texttt{docs/benchmarks/artifacts/test\_optimizer\_output.txt}
    \item \texttt{docs/benchmarks/benchmark\_results.md}
\end{itemize}
